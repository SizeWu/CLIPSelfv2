...
--name clipself_coco_6_save6_test1_eva_vitb16_12layers_shift_window_attn --downsample-factor 16 --det-image-size 1024 \
--alpha 0.7 --window-attention vitb16_shift8_ss16