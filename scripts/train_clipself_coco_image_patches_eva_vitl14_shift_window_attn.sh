...
--name clipself_coco_6_save6_test1_eva_vitl14_24layers_shift_window_attn --downsample-factor 14 \
--det-image-size 896 --alpha 0.95 --window-attention vitl14_shift8_ss16
